rec {
  shellHook-for = { package, pythoneda-base, python, nixpkgsRelease }: ''
    ...
    echo -e " \033[32m| '_ \| | | | __| '_ \ / _ \| '_ \ \033[34m/ _ \\\\\033[35m/ _\` |\033[36m/ _\` |\033[34mhttps://github.com/pythoneda-infrastructure/base\033[0m";
    ...
    echo -e " \033[32m|_|    |___/         \033[33mBASE (INFRASTRUCTURE)\033[0m";
    echo;
